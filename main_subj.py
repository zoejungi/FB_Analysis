...
for i in range(1, n_hFB+1):
    ...
    for j, df in enumerate(subjects_hFB[f'S{i}'].st):
        if j == 0:
            ...
            subjects_hFB[f'S{i}'].plot_SR(subjects_hFB[f'S{i}'].st[j]['time'], subjects_hFB[f'S{i}'].st[j]['SR_SMA5'], label=f'S{i} SR$_{{ST}}$', savingname=f'hFB_S{i}_ST_SR', target=False)
            subjects_hFB[f'S{i}'].plot_leftvsright(subjects_hFB[f'S{i}'].st[j]['time'], subjects_hFB[f'S{i}'].st[j]['ST_left'], subjects_hFB[f'S{i}'].st[j]['ST_right'], ylabel='ST [s]', savingname=f'hFB_S{i}_ST_lr')
    ...
    for j, df in enumerate(subjects_hFB[f'S{i}'].pof):
        if j == 1:
            ...
            subjects_hFB[f'S{i}'].plot_SR(subjects_hFB[f'S{i}'].pof[j]['time'], subjects_hFB[f'S{i}'].pof[j]['SR_SMA5'], label=f'S{i} SR$_{{POF}}$', savingname=f'hFB_S{i}_POF_SR', target=False)
            subjects_hFB[f'S{i}'].plot_leftvsright(subjects_hFB[f'S{i}'].pof[j]['time'], subjects_hFB[f'S{i}'].pof[j]['POF_left_SMA5'], subjects_hFB[f'S{i}'].pof[j]['POF_right_SMA5'], ylabel='POF [N]', savingname=f'hFB_S{i}_POF_lr')
    # APF
    for j, df in enumerate(subjects_hFB[f'S{i}'].apf):
        if j == 2:
            ...
            subjects_hFB[f'S{i}'].plot_SR(subjects_hFB[f'S{i}'].apf[j]['time'], subjects_hFB[f'S{i}'].apf[j]['SR_SMA5'], label=f'S{i} SR$_{{APF}}$', savingname=f'hFB_S{i}_APF_SR', target = False)
            subjects_hFB[f'S{i}'].plot_leftvsright(subjects_hFB[f'S{i}'].apf[j]['time'], subjects_hFB[f'S{i}'].apf[j]['apf_left'], subjects_hFB[f'S{i}'].apf[j]['apf_right'], ylabel='maxAPF [°]', savingname=f'hFB_S{i}_APF_lr')

    '''# Swingtime
    for j, df in enumerate(subjects_hFB[f'S{i}'].swingtime):
        subjects_hFB[f'S{i}'].plot_SR(subjects_hFB[f'S{i}'].swingtime[j]['time'], subjects_hFB[f'S{i}'].swingtime[j]['SR_SMA5'], label=f'S{i} SR$_{{swingtime}}$', savingname=f'hFB_S{i}_swingtime_SR', baseline=False, target = False)
    ...
    for j, df in enumerate(subjects_hFB[f'S{i}'].steplength):
        subjects_hFB[f'S{i}'].plot_SR(subjects_hFB[f'S{i}'].steplength[j]['time'], subjects_hFB[f'S{i}'].steplength[j]['SR_SMA5'], label=f'S{i} SR$_{{steplength}}$', savingname=f'hFB_S{i}_steplength_SR', baseline=False, target = False)
    ...
    for j, df in enumerate(subjects_hFB[f'S{i}'].stepheight):
        subjects_hFB[f'S{i}'].plot_SR(subjects_hFB[f'S{i}'].stepheight[j]['time'], subjects_hFB[f'S{i}'].stepheight[j]['SR_SMA5'], label=f'S{i} SR$_{{stepheight}}$', savingname=f'hFB_S{i}_stepheight_SR', baseline=False, target = False)
    ...
    for j, df in enumerate(subjects_hFB[f'S{i}'].stepwidth):
        subjects_hFB[f'S{i}'].plot_SR(subjects_hFB[f'S{i}'].stepwidth[j]['time'], subjects_hFB[f'S{i}'].stepwidth[j]['SR_SMA5'], label=f'S{i} SR$_{{stepwidth}}$', savingname=f'hFB_S{i}_stepwidth_SR', baseline=False, target = False)
    ...
    for j, df in enumerate(subjects_hFB[f'S{i}'].GRFz):
        subjects_hFB[f'S{i}'].plot_SR(subjects_hFB[f'S{i}'].GRFz[j]['time'], subjects_hFB[f'S{i}'].GRFz[j]['SR_SMA5'], label=f'S{i} SR$_{{meanGRFz}}$', savingname=f'hFB_S{i}_meanGRFz_SR', baseline=False, target = False)
    ...
    for j, df in enumerate(subjects_hFB[f'S{i}'].kneeflexion):
        subjects_hFB[f'S{i}'].plot_SR(subjects_hFB[f'S{i}'].kneeflexion[j]['time'], subjects_hFB[f'S{i}'].kneeflexion[j]['SR_SMA5'], label=f'S{i} SR$_{{max kneeflexion}}$', savingname=f'hFB_S{i}_kneeflexion_SR', baseline=False, target = False)
    ...
    if i != 2 and i != 3 and i != 4 and i != 6 and i != 12:
        ...
        for j, df in enumerate(subjects_vFB[f'S{i}'].st):
            if j == 0:
                ...
                subjects_vFB[f'S{i}'].plot_SR(subjects_vFB[f'S{i}'].st[j]['time'], subjects_vFB[f'S{i}'].st[j]['SR_SMA5'], label=f'S{i} SR$_{{ST}}$', savingname=f'vFB_S{i}_ST_SR', target = False)
                subjects_vFB[f'S{i}'].plot_leftvsright(subjects_vFB[f'S{i}'].st[j]['time'], subjects_vFB[f'S{i}'].st[j]['ST_left'], subjects_vFB[f'S{i}'].st[j]['ST_right'], ylabel='ST [s]', savingname=f'vFB_S{i}_ST_lr')
        ...
        for j, df in enumerate(subjects_vFB[f'S{i}'].pof):
            if j == 1:
                ...
                subjects_vFB[f'S{i}'].plot_SR(subjects_vFB[f'S{i}'].pof[j]['time'], subjects_vFB[f'S{i}'].pof[j]['SR_SMA5'], label=f'S{i} SR$_{{POF}}$', savingname=f'vFB_S{i}_POF_SR', target = False)
                subjects_vFB[f'S{i}'].plot_leftvsright(subjects_vFB[f'S{i}'].pof[j]['time'], subjects_vFB[f'S{i}'].pof[j]['POF_left_SMA5'], subjects_vFB[f'S{i}'].pof[j]['POF_right_SMA5'], ylabel='POF [N]', savingname=f'vFB_S{i}_POF_lr')
        ...
        for j, df in enumerate(subjects_vFB[f'S{i}'].apf):
            if j == 2:
                ...
                subjects_vFB[f'S{i}'].plot_SR(subjects_vFB[f'S{i}'].apf[j]['time'], subjects_vFB[f'S{i}'].apf[j]['SR_SMA5'], label=f'S{i} SR$_{{APF}}$', savingname=f'vFB_S{i}_APF_SR', target = False)
                subjects_vFB[f'S{i}'].plot_leftvsright(subjects_vFB[f'S{i}'].apf[j]['time'], subjects_vFB[f'S{i}'].apf[j]['apf_left'], subjects_vFB[f'S{i}'].apf[j]['apf_right'], ylabel='maxAPF [°]', savingname=f'vFB_S{i}_APF_lr')

        '''# Swingtime
        for j, df in enumerate(subjects_vFB[f'S{i}'].swingtime):
            subjects_vFB[f'S{i}'].plot_SR(subjects_vFB[f'S{i}'].swingtime[j]['time'], subjects_vFB[f'S{i}'].swingtime[j]['SR_SMA5'], label=f'S{i} SR$_{{swingtime}}$', savingname=f'vFB_S{i}_swingtime_SR', baseline=False, target = False)
        ...
        for j, df in enumerate(subjects_vFB[f'S{i}'].steplength):
            subjects_vFB[f'S{i}'].plot_SR(subjects_vFB[f'S{i}'].steplength[j]['time'], subjects_vFB[f'S{i}'].steplength[j]['SR_SMA5'], label=f'S{i} SR$_{{steplength}}$', savingname=f'vFB_S{i}_steplength_SR', baseline=False, target = False)
        ...
        for j, df in enumerate(subjects_vFB[f'S{i}'].stepheight):
            subjects_vFB[f'S{i}'].plot_SR(subjects_vFB[f'S{i}'].stepheight[j]['time'], subjects_vFB[f'S{i}'].stepheight[j]['SR_SMA5'], label=f'S{i} SR$_{{stepheight}}$', savingname=f'vFB_S{i}_stepheight_SR', baseline=False, target = False)
        ...
        for j, df in enumerate(subjects_vFB[f'S{i}'].stepwidth):
            subjects_vFB[f'S{i}'].plot_SR(subjects_vFB[f'S{i}'].stepwidth[j]['time'], subjects_vFB[f'S{i}'].stepwidth[j]['SR_SMA5'], label=f'S{i} SR$_{{stepwidth}}$', savingname=f'vFB_S{i}_stepwidth_SR', baseline=False, target = False)
        ...
        for j, df in enumerate(subjects_vFB[f'S{i}'].GRFz):
            subjects_vFB[f'S{i}'].plot_SR(subjects_vFB[f'S{i}'].GRFz[j]['time'], subjects_vFB[f'S{i}'].GRFz[j]['SR_SMA5'], label=f'S{i} SR$_{{meanGRFz}}$', savingname=f'vFB_S{i}_meanGRFz_SR', baseline=False, target = False)
        ...
        for j, df in enumerate(subjects_vFB[f'S{i}'].kneeflexion):
            subjects_vFB[f'S{i}'].plot_SR(subjects_vFB[f'S{i}'].kneeflexion[j]['time'], subjects_vFB[f'S{i}'].kneeflexion[j]['SR_SMA5'], label=f'S{i} SR$_{{max kneeflexion}}$', savingname=f'vFB_S{i}_kneeflexion_SR', baseline=False, target = False)
...
Plotting.plot_3SR_std(hFB_apf_t_duringST, hFB_apf_SR_duringST, hFB_apf_SR_std_duringST, hFB_apf_t_duringPOF, hFB_apf_SR_duringPOF, hFB_apf_SR_std_duringPOF, hFB_apf_t_duringAPF, hFB_apf_SR_duringAPF, hFB_apf_SR_std_duringAPF, 'APF during ST', 'APF during POF', 'APF during APF', show = True, color=[get_color('c', 0.15), get_color('c', 0.3), 'c'], savingname='hFB_meanPOF_SR_all', title = f'hFB, n = {len(subjects_hFB)}')

Plotting.plot_3SR_std(hFB_st_t_duringST, hFB_st_SR_duringST, hFB_st_SR_std_duringST, hFB_pof_t_duringPOF, hFB_pof_SR_duringPOF, hFB_pof_SR_std_duringPOF, hFB_apf_t_duringAPF, hFB_apf_SR_duringAPF, hFB_apf_SR_std_duringAPF, 'ST during ST', 'POF during POF', 'APF during APF', show = True, color=['orchid', 'burlywood', 'c'], savingname='hFB_SR_all', title = f'hFB, n = {len(subjects_hFB)}')
...
# comparison plots only responders
